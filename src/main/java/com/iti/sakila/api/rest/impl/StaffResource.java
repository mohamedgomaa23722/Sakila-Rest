...
public class StaffResource {
    ...
    public List<CustomerResponse> getStaffs(@DefaultValue("1") @QueryParam("page") int page) {
    ...
    @Path("search")
    @Produces(MediaType.APPLICATION_JSON)
    public List<CustomerResponse> findStaffByName(@QueryParam("name") String name,
    ...
    @Path("{id}")
    @Produces(MediaType.APPLICATION_JSON)
    public CustomerResponse findStaffById(@PathParam("id") int id) {
